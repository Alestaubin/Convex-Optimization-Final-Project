...
function [max_param, array_y] = grid_search(algorithm, i, ivals, test_param, array_of_params, b, kernel, problem)
...
%
    array_y = zeros(length(array_of_params), 1); % Initialize array of errors
    ...
    %fprintf(['a: ' repmat(' %f ',1,numel(array_y)) '\n'],array_y);
