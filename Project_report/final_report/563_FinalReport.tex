...
\begin{itemize}[leftmargin=*]
    ...
    \begin{align*}
        ...
        &= \bigg( \frac{t \gamma \cdot y_{1k}}{(y_{1k}^2 + y_{2k}^2)^{1/2}} - y_{1k} + u_k, \: \frac{t \gamma \cdot y_{2k}}{(y_{1k}^2 + y_{2k}^2)^{1/2}} - y_{2k} + v_k\bigg) \quad \text{by def. of convex hull}
    \end{align*}
    ...
    We remark that in the original paper \textcolor{red}{cite}, they define the proximal map of $f$ at $x$ to be $\argmin_u f(u) - 1/2\|u - x\|^2$ hence the difference in signs, although the same.
...
\end{equation}
It is mentioned that in our case, the solution turns out to be the Lagrangian of our generic optimization problem. \textcolor{red}{decription of the similarities and differences of CHambolle Pock from the other algos} The algorithm proceeds as below.
...
\textcolor{red}{summarize the following (or remove)}
