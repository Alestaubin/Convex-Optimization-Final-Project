...
\begin{itemize}[leftmargin=*]
    ...
    \end{align*}
    Remark that $(u_k^2 + v_k^2)^{1/2} = \| (u_k, v_k) \|^2_2$ for each $k$. The Fenchel conjugate of the L2 norm is itself (HW3). We also have that for any norm $\| \cdot \|$, the Fenchel conjugate $\| \cdot \|^*$ is the indicator of the unit ball in the dual norm $\delta_{\| \cdot \|_* \leq 1}$. The proximal mapping of the indicator of the unit ball is the projection onto the unit ball. Hence
    $$
